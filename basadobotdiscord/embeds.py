...
messageInfo.add_field(name="/másbasados", value="Muestra el top 10 de basados.", inline=False)
messageInfo.add_field(name="/cantidaddebasado", value="Muestra los basados según el usuario.", inline=False)
messageInfo.add_field(name="/frasecuñada", value="Envia una frase cuñada aleatoria.", inline=False)
